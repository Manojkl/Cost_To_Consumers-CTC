...
| Unitree Robotics | **R1** | Developers, research labs, education     | Bipedal walking, agile motions (running, cartwheels, handstands, punches); 26 DoF; ~25 kg (~55 lb), ~1.2 m tall 1 | Closed‑source core firmware; open developer SDK for motion control, sensors, AI middleware integration (e.g. ROS, frameworks); public SDKs and communication protocols available 2 | Starting at US $5,566–5,900 (39,900 CNY) 3 | Available internationally via Unitree website/distributors, global order options already active 4 | SDKs and sample code publicly available; motor‑protocol abstraction SDK open‑source; core motion firmware remains proprietary 5 | Online documentation & download centre; developer forums, GitHub repositories; distributor support in regions via resellers 6 |
